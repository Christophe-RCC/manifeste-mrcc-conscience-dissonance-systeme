...
Le MRCC postule que la **liberté** (le "potentiel d'action" parmi plusieurs trajectoires futures) n'est pas une propriété absolue, mais une fonction décroissante de la **densité de causalité** (la densité d'interactions ou de contraintes gravitationnelles).
