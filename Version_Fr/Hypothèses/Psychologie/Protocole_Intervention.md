...
> **Avertissement Important :** Ce document décrit un **protocole théorique** basé sur le *Modèle de la Réaction Causale Complexée (MRCC)*. Il ne constitue pas un avis médical, un diagnostic ou un traitement approuvé. L'application de ce protocole doit être supervisée par des professionnels de santé qualifiés. Le MRCC est un cadre d'interprétation, pas une thérapie autonome.

---

## 1. Principe Fondamental : La Guérison comme Réduction de Friction

Dans le cadre du MRCC, la santé mentale et physique n'est pas l'absence de symptômes, mais un **état de faible dissonance** (faible friction interne, haute fluidité énergétique). La pathologie est un **piège de dissonance** : le système maintient une configuration instable (croyances rigides, traumatismes non résolus) qui consomme une énergie disproportionnée.

**Thèse Opérationnelle :** La guérison n'est pas un acte de volonté (forcer le changement), mais un processus de **modification du paysage énergétique**. En ajustant les paramètres du système (environnement, croyances, physiologie), on rend l'état de santé la **voie de moindre énergie**.
...
## 3. Critères d'Observation et Falsifiabilité

Ce protocole est considéré comme **cohérent avec le modèle MRCC** si les observations suivantes sont faites :

1.  **Réduction de la souffrance subjective** après la Phase 1 (stabilisation physique).
2.  **Capacité d'intégration** : Le sujet commence à expliquer ses problèmes en termes de causes (contexte) plutôt que de fautes (volonté) après la Phase 2.
